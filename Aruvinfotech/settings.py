"""
Django settings for Aruvinfotech project.
...
SECRET_KEY = 'django-insecure-*%qr_35uxu@hmaksr%o1qnag$1xyn%ge07nt53*cz-4)3x!fpe'
...
ROOT_URLCONF = 'Aruvinfotech.urls'
...
WSGI_APPLICATION = 'Aruvinfotech.wsgi.application'
